;(function( $ ) {
        ...
        let methods = {
            model: class Model {
                ...
                countMoveAt(id: string, coords, pageX){
                    let pre;
                    ...
                    if (id === 'run-contain-1'){
                        if (pre >=0 && pre <= (coords.line_coords.width)){ 
                            if(coords.contain_2){
                                if (pre <= (coords.contain_2.left - coords.contain_2.width - coords.line_coords.left)) return pre;
                            }else {
                                return pre;
                            }
            ...
            view: class View {
                ...
                input_val_1 = 0
                input_val_2 = 100
                inputs_array: NodeListOf<Element>;
